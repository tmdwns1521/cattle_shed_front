...
<section class="main_1">
    ...
    <div class="main_2">
        <img src="./img/main_2.png" alt="마케팅 솔루션 이미지">
    </div>
    ...
    <section class="main_3">
        <div>
            ...
            <div>
                <span>상위노출 효과를 직접 경험하세요!</span> <img src="./img/don.png">
                <form>
    ...
    <div class="kakaobg">
        <div class="main_4">
            <div><img src="./img/main_kakao1.png" alt=""></div>
            <div class="bxslider">
                <div><img src="./img/kakaotalk_img1.png" alt="kakaotalk_img1"></div>
                <div> <img src="./img/kakaotalk_img2.png" alt="kakaotalk_img2"></div>
                <div><img src="./img/kakaotalk_img3.png" alt="kakaotalk_img3"></div>
                <div><img src="./img/kakaotalk_img4.png" alt="kakaotalk_img4"></div> 
            </div>
        </div>
    </div>
    ...
    <section class="main_5">
        <div>
            <div class="bxslider">
                <div><img src="./img/main_3.png" alt=""></div>
                <div><img src="./img/main_4.png" alt=""></div>
                <div><img src="./img/2_slider1.png" alt=""></div>
                <div><img src="./img/2_slider2.png" alt=""></div>
                <div><img src="./img/2_slider3.png" alt=""></div>
                <div><img src="./img/2_slider4.png" alt=""></div>
                <div><img src="./img/2_slider5.png" alt=""></div>
                <div><img src="./img/2_slider6.png" alt=""></div>
                <div><img src="./img/2_slider7.png" alt=""></div>
                <div><img src="./img/2_slider8.png" alt=""></div>
                <div><img src="./img/2_slider9.png" alt=""></div>
                <div><img src="./img/2_slider10.png" alt=""></div>
                <div><img src="./img/2_slider11.png" alt=""></div>
                <div><img src="./img/2_slider12.png" alt=""></div>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        ...
        <div>
            <p>대표 민경재</p>
            <p>상호 엔에스엠(NSM)</p>
            <p>사업자등록번호 417-16-97188</p>
            <p>주소 서울시 영등포구 경인로 775, 1동 215호(에이스하이테크시티)</p>
            <p>© 오늘부터 마케팅. All rights reserved.</p>
        </div>
    </footer>
</template> -->
